...
import {
  ...
  ShieldAlert, Flag, Sparkles, FileBarChart2, FileCheck2, Plug, History,
  BellDot, Search, Sparkle, Settings, ChevronDown, Sun, Moon, Crown, Briefcase, Wrench
} from "lucide-react";
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="sticky top-0 z-30 glass-panel border-b border-border">
          <div className="h-16 px-5 lg:px-8 flex items-center gap-4">
            ...
            <Button size="icon" variant="ghost" className="rounded-xl relative" data-testid="button-notifications">
              <BellDot className="size-4" />
              <span className="absolute top-2 right-2 size-1.5 rounded-full bg-[#FFA38B] pulse-dot" />
            </Button>
            <Button size="icon" variant="ghost" className="rounded-xl" data-testid="button-settings">
        ...
        <main className="flex-1 min-w-0 p-5 lg:p-8 max-w-[1600px] w-full mx-auto">
          {children}
        </main>
      </div>
    </div>
